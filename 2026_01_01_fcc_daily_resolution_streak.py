...
if __name__ == '__main__':
    ...
    # Test 1 should return "Resolution on track: 3 day streak."
    print(resolution_streak([[10500, 75, 15], [11000, 90, 10], [10650, 100, 9]]))
    # Test 2 should return "Resolution failed on day 2: 1 day streak."
    print(resolution_streak([[10000, 120, 5], [10950, 121, 11]]))
    # Test 3 should return "Resolution failed on day 3: 2 day streak."
    print(resolution_streak([[15000, 110, 8], [12300, 60, 13], [10100, 120, 4], [9000, 125, 4]]))
    # Test 4 should return "Resolution failed on day 4: 3 day streak."
    print(resolution_streak([[11600, 76, 13], [12556, 64, 26], [10404, 32, 59], [9999, 44, 124], [7508, 23, 167], [10900, 80, 0]]))
    # Test 5 should return "Resolution on track: 10 day streak."
